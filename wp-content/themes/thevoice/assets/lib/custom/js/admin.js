(function ($) {
    ...
    var ajaxurl = thevoice_admin.ajax_url;
    var thevoiceNonce = thevoice_admin.ajax_nonce;
    var custom_theme_file_frame;

    // Category Color
    $('#news-fort-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: thevoice_admin.upload_image,
            button: {
            text: thevoice_admin.use_imahe
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'thevoice_notice_dismiss',
            '_wpnonce': thevoiceNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-thevoice-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-thevoice-notice').addClass('twp-installing');

        var data = {
            'action': 'thevoice_install_plugins',
            '_wpnonce': thevoiceNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = thevoice_admin.active
            var deactivate = thevoice_admin.deactivate
