 ...
 * @package TheVoice
 */
if (!function_exists('thevoice_grid_post_widgets')) :
     ...
     * @since 1.0.0
     */
    function thevoice_grid_post_widgets()
    {

        // Grid Post widget.
        register_widget('TheVoice_Sidebar_Grid_Posts_Widget');

    }

endif;

add_action('widgets_init', 'thevoice_grid_post_widgets');

// Grid Post widget
if (!class_exists('TheVoice_Sidebar_Grid_Posts_Widget')) :
    ...
    class TheVoice_Sidebar_Grid_Posts_Widget extends TheVoice_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $opts = array(
                'classname' => 'thevoice_grid_post_widget',
            ...
            parent::__construct('TheVoice-grid-1-posts', esc_html__('TheVoice: Layout Grid', 'thevoice'), $opts, array(), $fields);
