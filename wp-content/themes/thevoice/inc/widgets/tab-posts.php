...
if ( !function_exists('thevoice_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function thevoice_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('TheVoice_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'thevoice_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('TheVoice_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class TheVoice_Tab_Posts_Widget extends TheVoice_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'thevoice_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'thevoice'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'thevoice'),
                    'type'           => 'heading',
                ),
                'popular_title' => array(
                    'label' => esc_html__('Popular Tab Title', 'thevoice'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Popular', 'thevoice'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'thevoice'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'enable_discription' => array(
                    'label'             => esc_html__('Enable Description:', 'thevoice'),
                    'type'              => 'checkbox',
                    'default'           => true,
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'thevoice'),
                    'description'   => esc_html__('Number of words', 'thevoice'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'thevoice'),
                    'type'          => 'heading',
                ),
                'recent_title' => array(
                    'label' => esc_html__('Recent Tab Title', 'thevoice'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Recent', 'thevoice'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'thevoice'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'thevoice'),
                    'type'            => 'heading',
                ),
                'comment_title' => array(
                    'label' => esc_html__('Comment Tab Title', 'thevoice'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Comments', 'thevoice'),
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'thevoice'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'thevoice-tabbed', esc_html__( 'TheVoice: Sidebar Tab Widget', 'thevoice' ), $opts, array(), $fields );
