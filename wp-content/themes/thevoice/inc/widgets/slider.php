 ...
 * @package TheVoice
 */
if ( !function_exists('thevoice_slider_post_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function thevoice_slider_post_widgets(){
        // Slider Post widget.
        register_widget('TheVoice_Sidebar_Slider_Posts_Widget');
    }
endif;
add_action('widgets_init', 'thevoice_slider_post_widgets');
// Slider Post widget
if ( !class_exists('TheVoice_Sidebar_Slider_Posts_Widget') ) :
    /**
     * Slider Post.
     *
     * @since 1.0.0
     */
    class TheVoice_Sidebar_Slider_Posts_Widget extends TheVoice_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'thevoice_slider_post_widget',
            ...
            $fields = array(
                ...
                'slider_excerpt' => array(
                    'label' => esc_html__('Enable Slider Excerpt', 'thevoice'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'slider_arrow' => array(
            ...
            parent::__construct( 'TheVoice-slider-posts', esc_html__('TheVoice: Slider Widget', 'thevoice'), $opts, array(), $fields );
        }
        /**
