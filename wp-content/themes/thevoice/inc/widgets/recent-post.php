 ...
 * @package TheVoice
 */
if ( !function_exists('thevoice_recent_post_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function thevoice_recent_post_widgets(){
        // Recent Post widget.
        register_widget('TheVoice_Sidebar_Recent_Post_Widget');
    }
endif;
add_action('widgets_init', 'thevoice_recent_post_widgets');
// Recent Post widget
if ( !class_exists('TheVoice_Sidebar_Recent_Post_Widget') ) :
    /**
     * Recent Post.
     *
     * @since 1.0.0
     */
    class TheVoice_Sidebar_Recent_Post_Widget extends TheVoice_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'thevoice_recent_post_widget',
            ...
            $fields = array(
                ...
                'enable_counter' => array(
                    'label' => esc_html__('Enable Counter:', 'thevoice'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'post_number' => array(
            ...
            parent::__construct( 'TheVoice-popular-sidebar-layout', esc_html__('TheVoice: Sidebar Recent Post Widget', 'thevoice'), $opts, array(), $fields );
        }
        /**
