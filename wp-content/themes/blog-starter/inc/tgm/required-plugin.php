 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme blog_starter for publication on ThemeForest
...
add_action( 'tgmpa_register', 'blog_starter_register_required_plugins' );
 ...
 */
function blog_starter_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'blog-starter',                 // Unique ID for hashing notices for multiple instances of TGMPA.
